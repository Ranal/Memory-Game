...
def vaheta_pilt1(event):
    # global deklaratsioon võimaldab muuta funktsioonist väljaspool
    # defineeritud muutujat
    global näidatav_pilt1

    # vahetan pildi viite
    if näidatav_pilt1 == suletud1:
        näidatav_pilt1 = avatud1
    else:
        näidatav_pilt1 = suletud1

    # ... ja uuendan selle viite põhjal tahvlil oleva pildi sisu
    tahvel.itemconfigure(img, image=näidatav_pilt1)
...
avatud = PhotoImage(file="b.gif")
näidatav_pilt = suletud

suletud1 = PhotoImage(file="bg.gif")
avatud1 = PhotoImage(file="a.gif")
näidatav_pilt1 = suletud1
img = tahvel.create_image(135, 150,image = näidatav_pilt1, anchor=NW)
tahvel.tag_bind(img, '<1>', vaheta_pilt1)

img = tahvel.create_image(245, 150,image = näidatav_pilt, anchor=NW)
